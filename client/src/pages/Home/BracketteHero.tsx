    ...
    <Paper className="brackette-hero-paper">
      <Grid>
        ...
        <Typography variant="h5" paragraph>
          Make tournament management even easier with Brackette by realeasing the full potential of Challonge and
          Smash.gg
        </Typography>
        <Button color="primary" variant="contained" size="large" component={({ innerRef, ...props }) => <Link {...props} to="/register" />}>
          Register
        </Button>
        <Button color="secondary" variant="outlined" size="large" id="about" component={({ innerRef, ...props }) => <Link {...props} to="/about" />}>
          About Brackette
        </Button>
